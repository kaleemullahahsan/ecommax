...
const RISING_BAMBOO_KIRKI_SECTION_ADVANCED_GRADIENT         = RISING_BAMBOO_PREFIX . 'section_advanced_gradient';
const RISING_BAMBOO_KIRKI_SECTION_ADVANCED_GRADIENT_ENABLE  = RISING_BAMBOO_PREFIX . 'section_advanced_gradient_enable';
const RISING_BAMBOO_KIRKI_SECTION_ADVANCED_GRADIENT_COLOR_1 = RISING_BAMBOO_PREFIX . 'section_advanced_gradient_color_1';
const RISING_BAMBOO_KIRKI_SECTION_ADVANCED_GRADIENT_COLOR_2 = RISING_BAMBOO_PREFIX . 'section_advanced_gradient_color_2';
const RISING_BAMBOO_KIRKI_SECTION_ADVANCED_GRADIENT_COLOR_3 = RISING_BAMBOO_PREFIX . 'section_advanced_gradient_color_3';
const RISING_BAMBOO_KIRKI_SECTION_ADVANCED_GRADIENT_COLOR_4 = RISING_BAMBOO_PREFIX . 'section_advanced_gradient_color_4';
const RISING_BAMBOO_KIRKI_SECTION_ADVANCED_GRADIENT_TIME    = RISING_BAMBOO_PREFIX . 'section_advanced_gradient_time';
const RISING_BAMBOO_KIRKI_SECTION_ADVANCED_GRADIENT_DEG     = RISING_BAMBOO_PREFIX . 'section_advanced_gradient_deg';
