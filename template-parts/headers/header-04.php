...
?>
<header id="rbb-default-header" class="rbb-default-header header-4 ">
	<div class="relative w-full">
			<div class="relative">
				<div class="header-inner mx-auto h-full gradient-animate">
					<div class="md:block hidden 2xl:container px-[15px] mx-auto">
						<div class="mx-auto rbb-header-top flex items-center">
							<div class="contentsticky_logo rbb-logo basis-1/5 flex items-center justify-start w-full">
								<?php
								if ( Helper::show_logo() ) {
									?>
							...
							<div class="basis-4/5 flex w-full items-center justify-between">
								...
								<div class="contentsticky_header_right flex items-center header_right_content justify-end">
			...
			<div class="rbb-header-center bg-transparent relative">
				<div class="md:block hidden 2xl:container px-[15px] mx-auto ">
					<div class="mx-auto flex items-center justify-between">
						<?php
						if ( $menu_vertical ) {
							?>
						<div class="basis-1/5 header-center-left min-w-[300px] all-categories rissing_overlay_blur" data-backdrop="<?php echo esc_attr($class_string); ?>" data-repond="1024">
							<div class="duration-300 cursor-pointer flex items-center text-[#181818] relative categories-text pl-5 pr-6">
								<i class="rbb-icon-menu-6 text-2xl text-[#181818] mr-6"></i>
								<span class="text-[10px] uppercase font-bold text-[#181818]"><?php echo esc_html__('Browse All Category', 'ecommax'); ?></span>
						...
						<div class="header-center-right flex items-center justify-between <?php echo $menu_vertical ? 'basis-4/5' : 'basis-full w-full'; ?>">
							<?php if ( Helper::show_search_product_form() ) { ?>
								<div class="site-header-search  ml-[10px] grow">
									...
									<?php } else { ?>
										...
										<?php if ( ! empty(Helper::get_popular_keyword()) ) { ?>
											<div class="items-center justify-start lg:flex hidden <?php echo $menu_vertical ? 'host-search' : 'hot-search-zero'; ?>">
												<div class="heading-search text-xs font-bold uppercase text-[var(--rbb-general-heading-color:)] mr-2"><i class="rbb-icon-flash-1 mr-4"></i><?php echo esc_html__('SEARCH TRENDING :', 'ecommax'); ?></div>
												<ul class="rbb-search-popular overflow-x-auto flex text-[var(--rbb-general-heading-color:)] capitalize text-xs">
													<?php foreach ( Helper::get_popular_keyword() as $keyword ) { ?>
			...
			<div class="rbb-header-bottom bg-[#f5f5f7] hidden lg:flex">
				<div class="md:block hidden 2xl:container px-[15px] mx-auto">
	...
	<div class="sticky_header">
		<div class="rbb-header-sticky relative z-50 opacity-0 invisible gradient-animate">
			<div class="flex flex-nowrap items-center justify-between w-full container mx-auto h-full">
	...
	<div class="header-mobile gradient-animate px-[15px] md:hidden">
		<div class="flex items-center justify-between max-h-[60px]">
			...
			<div class="header-mobile-right min-w-[60px] flex items-center justify-end">
				...
				if ( $menu_vertical ) {
					?>
				<div class="all-categories ml-5"><i class="rbb-icon-menu-6 text-white text-2xl"></i></div>
				<?php } ?>
			</div>
		</div>
	</div>
