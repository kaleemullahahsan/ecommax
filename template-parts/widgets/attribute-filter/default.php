		...
		if ( 'swatches' === $style ) {
			?>
				...
				switch ( $attr_info->type ) {
					...
					case 'text':
						?>
						<li class="rbb-attribute-filter-item item m-1.5 inline-block <?php echo esc_attr('inline' === $display) ? ' float-left' : 'block'; ?> <?php echo esc_attr($active_class); ?> <?php echo ( 1 === $show_count ) ? 'show_count' : ''; ?>">
