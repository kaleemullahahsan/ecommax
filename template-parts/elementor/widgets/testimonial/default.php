...
if ( $testimonials ) {
	?>
	<div id="<?php echo esc_attr($id); ?>" class="rbb-elementor-slider rbb-testimonial lg:pt-0 md:pt-7 relative <?php echo esc_attr($layout); ?>">
				...
				<div class="item item-<?php echo esc_attr($testimonial->ID); ?>">
					<div class="block_content">
						<div class="flex items-center testimonial_avartar justify-center relative">
							<div class="rounded-full overflow-hidden">
								...
								if ( has_post_thumbnail($testimonial) ) {
									...
									?>
									<img class="object-cover !w-[80px] !h-[80px]" src="<?php echo esc_url(get_stylesheet_directory_uri() . '/dist/images/default-thumbnail.png'); ?>" alt="<?php echo esc_attr__('Default post thumbnail', 'ecommax'); ?>" >
								<?php } ?>
							</div>
						</div>
						<div class="block_content-text text-center mt-7">
							...
							<div class="testimonial_text text-sm mb-6 line-clamp-8 relative leading-[23px]">
