							...
							<div class="<?php echo esc_attr(( $parallax ) ? 'parallax' : ''); ?> m-auto relative h-full">
								...
								if ( $slider_title || $slider_sub_title || $description || $button_1 || $button_2 ) {
									...
									switch ( $vertical_align ) {
										case 'bottom':
											$vertical_align_class = 'md:bottom-[90px] bottom-8';
											break;
										case 'middle':
											$vertical_align_class = 'top-1/2 transform -translate-y-1/2';
											break;
										default:
											$vertical_align_class = 'md:top-[90px] top-8';
									}
									?>
										...
										<div class="info-inner">
											...
											if ( $slider_title ) {
												...
												<h2 data-visibility-start="<?php echo esc_attr($title_visibility); ?>"
													...
													class="title md:text-base text-sm lg:mb-3 <?php echo esc_attr($title_visibility); ?>"
												>
											...
											if ( $slider_sub_title ) {
												...
												<h3 data-visibility-start="<?php echo esc_attr($subtitle_visibility); ?>"
													...
													class="sub-title md:text-3xl text-[20px] md:mb-2<?php echo esc_attr($subtitle_visibility); ?>"
												>
											...
											<div class="button-group inline-flex justify-center items-center flex-col md:flex-row md:justify-end mr-[15px]">
												<?php
