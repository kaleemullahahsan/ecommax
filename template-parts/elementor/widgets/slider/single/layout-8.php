...
if ( $sliders ) {
	...
	<div id="<?php echo esc_attr($id); ?>" class="rbb-elementor-slider md:justify-start <?php echo esc_attr($layout_type); ?> <?php echo esc_attr($layout); ?>">
		<div class="flex rbb-slick-carousel slick-carousel slick-carousel-center load-item-2" data-speed="<?php echo esc_attr($autoplay_speed); ?>" data-slick='{
			...
			foreach ( $sliders as $slider ) {
				...
				<div class="item elementor-repeater-item-<?php echo esc_attr($slider['_id']); ?>">
					<div class="item-content relative rounded-[20px]">
