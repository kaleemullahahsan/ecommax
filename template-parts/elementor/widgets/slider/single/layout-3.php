			...
			foreach ( $sliders as $slider ) {
				...
				<div class="w-full item elementor-repeater-item-<?php echo esc_attr($slider['_id']); ?>">
					<div class="item-content relative rounded-[10px]">
						<div class="md:absolute md:py-0 pt-14 pb-14 top-0 w-full h-full">
								...
								if ( $slider_title || $slider_sub_title || $description || $button_1 || $button_2 ) {
									...
									switch ( $horizontal_align ) {
										...
										case 'center':
											...
											break;
										default:
											$horizontal_align_class = 'left-[46px] md:text-left text-center';
									}
									...
									?>
									<div class="md:absolute info-wap lg:w-[75%] md:w-1/2 z-50 <?php echo esc_attr($horizontal_align_class); ?> <?php echo esc_attr($vertical_align_class); ?>">
										<div class="info-inner md:px-[15px]">
											...
											<div class="button-group flex justify-center items-center flex-col md:flex-row md:text-left text-center md:justify-<?php echo wp_kses_post($horizontal_align_center); ?>">
												<?php
												...
												if ( $button_1 ) {
													...
													<a <?php echo ( 'url' !== $button_1_type ) ? 'onclick="RisingBambooModal.modal(\'#rbb-modal-button-01-' . esc_attr($slider['_id']) . '\', event)"' : ''; ?>
														...
														class="rbb-slick-button button-1 h-[52px] px-9 leading-[52px] rounded-[5px] inline-block transition duration-300 ease-in-out transform mt-5 md:mt-0 <?php echo esc_attr($button_1_visibility); ?>"
														<?php
														...
														?>
													>
														<span class="button-text flex items-center font-bold"><?php echo wp_kses_post($button_1); ?></span>
														<?php
														if ( $button_1_icon ) {
															?>
												...
												if ( $button_2 ) {
													...
													<span class="button-icon xl:w-14 xl:h-14 w-10 h-10 rounded-full text-center inline-block align-middle">
														...
														<span class="button-text flex items-center md:ml-1 lg:ml-3 font-bold"><?php echo wp_kses_post($button_2); ?></span>
													</a>
													<?php
