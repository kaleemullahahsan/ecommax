...
if ( $sliders ) {
	...
	<div id="<?php echo esc_attr($id); ?>" class="rbb-elementor-slider md:justify-start <?php echo esc_attr($layout_type); ?> <?php echo esc_attr($layout); ?>">
								...
								if ( $slider_title || $slider_sub_title || $description || $button_1 || $button_2 ) {
									...
									switch ( $horizontal_align ) {
										...
										case 'center':
											...
											break;
										default:
											$horizontal_align_class = 'left-[55px] md:text-left text-center';
									}
									...
									?>
									<div class="md:absolute info-wap lg:w-[45%] md:w-1/2 z-50 <?php echo esc_attr($horizontal_align_class); ?> <?php echo esc_attr($vertical_align_class); ?>">
										<div class="info-inner md:px-[15px]">
											...
											if ( $slider_title ) {
												...
												<h2 data-visibility-start="<?php echo esc_attr($title_visibility); ?>"
													...
													class="title md:text-2xl lg:text-4xl lg:mb-5 <?php echo esc_attr($title_visibility); ?>"
												>
											...
											if ( $description ) {
												...
												<div data-visibility-start="<?php echo esc_attr($description_visibility); ?>"
													...
													class="description md:mb-7 <?php echo esc_attr($description_visibility); ?>"
												>
		...
		<?php if ( isset($show_pagination) && 'true' === $show_pagination ) { ?>
			<div class="slideshow-dot flex justify-center absolute w-full mb-4">
				<?php
				$i = 0;
				foreach ( $sliders as $slider ) {
					?>
