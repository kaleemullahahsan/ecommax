							...
							<div class="item elementor-repeater-item-<?php echo esc_attr($slider['_id']); ?>">
								<div class="block__content relative duration-300 bg-white text-center">
									<?php if ( $slider[ $slick->get_name_setting('multiple_content_image') ]['url'] ) { ?>
										<img class="pb-4 !inline-block image-content" src="<?php echo esc_url($slider[ $slick->get_name_setting('multiple_content_image') ]['url']); ?>" alt="<?php echo esc_attr($slider[ $slick->get_name_setting('multiple_content_title') ]); ?>">
									<?php } ?>
									<?php if ( $slider[ $slick->get_name_setting('multiple_content_title') ] ) { ?>
										<h4 class="text-sm font-semibold pb-2.5 text-[color:var(--rbb-general-heading-color)] mt-2">
											<?php
