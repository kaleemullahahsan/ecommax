				...
				<?php } ?>
					<div class="block_slide">
						...
						foreach ( $sliders as $slider ) {
							...
							<div class="block-content-img rounded-full flex justify-center items-center shadow-[3px_3px_6px_0_rgba(0,0,0,0.08)] bg-white">
								<a class="inline-flex items-center justify-center w-full h-full" <?php echo ! empty($content_link_attr_string) ? $content_link_attr_string : 'href="' . esc_url($button_url) . '"'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
									...
									<?php if ( $slider[ $slick->get_name_setting('multiple_content_title') ] ) { ?>
										<h4 class="text-sm font-semibold pb-2.5 text-[color:var(--rbb-general-heading-color)] mt-8">
											<?php
