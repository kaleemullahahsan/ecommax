	...
	<div id="<?php echo esc_attr($id); ?>" class="rbb_woo_products <?php echo esc_attr($layout); ?>">
		...
		<div class="2xl:container px-[15px] mx-auto">
			<div class="block_content">
				<?php if ( $show_title || $show_filter || $show_arrows ) { ?>
				<div class="flex items-center justify-between md:mb-[42px] mb-8 block_heading">
					<?php if ( $show_title ) { ?>
				...
				<?php } ?>
				<div class="rbb-slick-carousel slick-carousel slick-carousel-center overflow-hidden load-item-<?php echo esc_attr($slides_per_row); ?> <?php
				if ( $row >= 2 ) {
					echo 'row-product';}
				?>
				" data-slick='{
