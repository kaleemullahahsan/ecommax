...
if ( count($data['products']) ) {
	...
	<div id="<?php echo esc_attr($id); ?>" class="rbb_woo_products <?php echo esc_attr($layout); ?>">
		...
		<div class="block_content">
			<?php if ( $show_title || $show_filter ) { ?>
			<div class="flex items-center justify-between block_heading mb-8">
				<div class="block_title flex justify-center items-center">
					<?php if ( $show_title ) { ?>
					<div class="title_section relative
						<?php
						if ( $show_filter ) {
							echo 'title_after'; }
						?>
						...
						if ( '1' < $cat_count || ( $show_filter && '1' === $cat_count ) ) {
							?>
								<div class="flex items-center justify-center">
									<div class="nav-dropdown-title-content mr-1 text-base text-[#909090]">
									<?php echo esc_html__('Sort By', 'ecommax'); ?>
									</div>
				...
				<?php if ( $show_arrows ) { ?>
					<div class="block_title_tab flex items-center">
							<div class="arrow-custom md:flex hidden">
			...
			<?php } ?>
			<div class="rbb-slick-carousel rbb-product-content slick-carousel overflow-hidden slick-carousel-center load-item-<?php echo esc_attr($slides_per_row); ?>" data-slick='{
