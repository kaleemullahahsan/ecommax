...
<div id="<?php echo esc_attr($id); ?>" class="rbb-banner relative overflow-hidden rounded-[10px] <?php echo esc_attr($layout); ?>">
	<div class="relative h-full">
		<div class="mx-auto absolute text-left w-full z-10 top-[13%] left-[50px] transition-all pr-[50px]">
			<div class="block_heading">
				...
				<?php if ( $description ) { ?>
					<div class="desc mt-2 mb-5 font-medium"><?php echo wp_kses_post($description); ?></div>
				<?php } ?>
				<?php
