...
<div id="<?php echo esc_attr($id); ?>" class="rbb-banner group relative overflow-hidden rounded-[10px] <?php echo esc_attr($layout); ?>">
	<div class="relative">
		<div class="mx-auto absolute text-left px-10 w-full z-10 top-1/2 -translate-y-1/2 transition-all">
			<div class="block_heading">
				...
				<?php if ( $description ) { ?>
					<div class="desc mt-3 mb-5 font-medium"><?php echo wp_kses_post($description); ?></div>
				<?php } ?>
				<?php
