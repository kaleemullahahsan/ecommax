...
<div id="<?php echo esc_attr($id); ?>" class="rbb-banner group relative overflow-hidden rounded-[10px] <?php echo esc_attr($layout); ?>">
	<div class="relative">
		<div class="mx-auto absolute text-left pl-10 pt-9 w-1/2 z-10 transition-all">
			<div class="block_heading">
				...
				<?php if ( $description ) { ?>
					<div class="desc mt-2 mb-5 font-base text-sm text-[color:var(--rbb-general-heading-color)] leading-6"><?php echo wp_kses_post($description); ?></div>
				<?php } ?>
				<?php
