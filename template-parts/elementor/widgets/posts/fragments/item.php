...
<div class="item basis-0">
	<div class="blog_item transition duration-700 shadow-[6px_6px_20px_0px_rgba(0,0,0,0.1)] group overflow-hidden rounded-[10px] bg-white">
		...
		<div class="blog_info pl-5 pr-[10px] pb-[10px]">
			<a href="<?php echo esc_url(get_permalink($_post)); ?>" class="blog_title font-semibold text-base mb-7 block leading-[26px]"><span class="blog_title line-clamp-2"><?php echo get_the_title($_post); ?></span></a>
