...
<div id="payment" class="woocommerce-checkout-payment">
	...
	<div class="form-row place-order">
		<noscript>
			...
			printf(esc_html__('Since your browser does not support JavaScript, or it is disabled, please ensure you click the %1$sUpdate Totals%2$s button before placing your order. You may be charged more than the amount stated above if you fail to do so.', 'ecommax'), '<em>', '</em>');
			?>
			<button type="submit" class="button alt" name="woocommerce_checkout_update_totals" value="<?php esc_attr_e('Update totals', 'ecommax'); ?>"><?php esc_html_e('Update totals', 'ecommax'); ?></button>
		</noscript>
