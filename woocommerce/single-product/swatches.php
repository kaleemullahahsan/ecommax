...
>
	...
	<?php if ( empty($available_variations) && false !== $available_variations ) { ?>
		<p class="stock out-of-stock"><?php esc_html__('This product is currently out of stock and unavailable.', 'ecommax'); ?></p>
	<?php } else { ?>
		<div class="variations flex flex-wrap justify-flex-start">
			...
			<div class="clear-variations w-full order-[1]">
				<div class="value uppercase text-xs pt-2 font-medium relative">
					<a class="reset_variations reset_variations--single pl-5" href="#"><?php esc_html_e('Clear', 'ecommax'); ?></a>
				</div>
			</div>
		</div>
