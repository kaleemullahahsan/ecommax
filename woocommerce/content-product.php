...
<div class="item md:px-[15px] px-1.5 !flex justify-center h-auto">
	<div class="item-product">
		<div class="relative rounded-[10px] z-10 content-product-category">
		...
		<div class="product_info w-full px-5 pb-9 mt-6">
			...
			if ( $show_add_to_cart ) {
				?>
				<div class="list-add-to-cart hidden">
				<?php
				$args      = [];
				$text_cart = '';
				...
				if ( $icon ) {
					$args['cart-icon'] = '<div class="add-to-cart-icon relative text-center leading-12">
						<i class="rbb-icon ' . $icon . '"></i>
						<span class="title-tooltips absolute whitespace-nowrap opacity-0 text-white">' . $text_cart . '</span>' . $text_cart . '
					</div>';
				}
